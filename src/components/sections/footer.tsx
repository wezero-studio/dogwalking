  ...
  return (
    <footer className="w-full bg-[#F9F4EB] font-sans">
      <div className="w-full mx-auto px-6 md:px-16 lg:px-24 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-4 items-start border-b border-[#2E1C3B]/20 pb-16">
          ...
          <div className="col-span-1 md:col-span-3 flex justify-center md:justify-start">
            <div className="flex flex-col items-center text-center">
              ...
              />
              <span className="text-[#2E1C3B] text-[12px] md:text-[14px] font-semibold tracking-[0.2em] uppercase mt-2">
                Dog Walkers
              </span>
            </div>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start gap-4">
            {col1Links.map(link => (
              <a key={link.label} href={link.href} className="text-[#2E1C3B] text-[15px] font-bold hover:text-[#FF5722] transition-colors">
                {link.label}
              </a>
            ))}
          </div>
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col items-center md:items-start gap-4 mt-8 md:mt-0">
            <AnimatedHeading
              ...
              className="text-[#2E1C3B] text-[28px] md:text-[36px] font-bold uppercase m-0 leading-none"
              style={{ fontFamily: "'Shantell Sans', cursive", fontWeight: 700 }}
            />
            <div className="flex gap-3">
              {/* Social Icons - circle outline */}
              <a href="#" className="w-9 h-9 rounded-full border-[1.5px] border-[#2E1C3B] flex items-center justify-center text-[#2E1C3B] hover:bg-[#FF5722] hover:border-[#FF5722] hover:text-[#F9F4EB] transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 gap-4">
          <p className="text-[#2E1C3B]/80 text-[13px] md:text-[14px] font-medium tracking-wide">
