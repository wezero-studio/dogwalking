  ...
  return (
    <footer className="w-full bg-[#F9F4EB] font-sans">
      <div className="w-full mx-auto px-6 md:px-16 lg:px-24 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-4 items-start border-b border-[#1B3B2C]/20 pb-16">
          ...
          <div className="col-span-1 md:col-span-3 flex flex-col items-center md:items-start gap-4 mt-8 md:mt-0">
            <AnimatedHeading
              ...
              className="text-[#1B3B2C] text-[28px] md:text-[36px] font-bold uppercase m-0 leading-none"
              style={{ fontFamily: "'Shantell Sans', cursive", fontWeight: 700 }}
            />
            <div className="flex gap-3">
              {/* Social Icons - circle outline */}
              <a href="#" className="w-9 h-9 rounded-full border-[1.5px] border-[#1B3B2C] flex items-center justify-center text-[#1B3B2C] hover:bg-[#FF5722] hover:border-[#FF5722] hover:text-[#F9F4EB] transition-colors">
